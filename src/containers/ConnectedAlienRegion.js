...
function mapDispatchToProps(dispatch, ownProps) {
  return {
    ...
    setRegionStateMoveDispatch: (index, x, y, clientPosX, clientPoxY) =>
      dispatch(setRegionStateMove(index, x, y, clientPosX, clientPoxY)),
...
export default connect(mapStateToProps, mapDispatchToProps)(AlienRegion)
